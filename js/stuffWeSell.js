...
petList.push(new thing("Adam", 50.00,
    new image("Petshop-project/img/pets/adam.jpg", "A picture of Adam, a bearded dragon"),
...
petList.push(new thing("Alvan", 20.00,
    new image("Petshop-project/img/pets/alvan.jpg", "A picture of Alvan, a corgi"),
...
petList.push(new thing("Amy", 20.00,
    new image("Petshop-project/img/pets/amy.jpg", "A picture of Amy, a golden retriever"),
...
petList.push(new thing("Ben", 50.00,
    new image("Petshop-project/img/pets/ben.jpg", "A picture of Ben, a bearded dragon"),
...
petList.push(new thing("Cyrus", 20.00,
    new image("Petshop-project/img/pets/cyrus.jpg", "A picture of Cyrus, an exotic shorthair cat"),
...
petList.push(new thing("Erin", 50.00,
    new image("Petshop-project/img/pets/erin.jpg", "A picture of Erin, a particularly jubulent bearded dragon"),
...
petList.push(new thing("Jae", 15.00,
    new image("Petshop-project/img/pets/jae.jpg", "A picture of Jae, a calico cat"),
...
petList.push(new thing("Karsten", 15.00,
    new image("Petshop-project/img/pets/karsten.jpg", "A picture of Jae, a campiero bulldog (we think!)"),
...
petList.push(new thing("Loan", 25.00,
    new image("Petshop-project/img/pets/loan.jpg", "A picture of Loan, a kitten"),
...
petList.push(new thing("Nadezhda", 25.00,
    new image("Petshop-project/img/pets/nadezhda.jpg", "A picture of Nadezhda, a shorthair kitten"),
...
petList.push(new thing("Raoul-droog", 1000.00,
    new image("Petshop-project/img/pets/Raoul-droog.jpg", "A picture of Raoul-droog, a british shorthair"),
...
petList.push(new thing("Trevor", 30.00,
    new image("Petshop-project/img/pets/trevor.jpg", "A picture of Trevor, a spaniel"),
...
new image("Petshop-project/img/products/cat-complex.jpg", "A cat complex"),
...
new image("Petshop-project/img/products/cat-toy.jpg", "A cat playing with a cat toy"),
...
new image("Petshop-project/img/products/cat-tree.jpg", "A cat tree with various features"),
...
new image("Petshop-project/img/products/cat-worm.jpg", "A cat toy featuring a wooly worm"),
...
new image("Petshop-project/img/products/dogbed-round.jpg", "A rounded dog bed"),
...
new image("Petshop-project/img/products/dogbed.jpg", "A flat dog bed"),
...
new image("Petshop-project/img/products/medium-doghouse.jpg", "A medium sized dog house"),
...
new image("Petshop-project/img/products/pet-cream.jpg", "A small dog standing next to a bottle of pet cream"),
...
new image("Petshop-project/img/products/scratching-cactus.jpg", "A cactus themed scratching post"),
...
new image("Petshop-project/img/products/scratching-post.jpg", "A scratching post"),
...
new image("Petshop-project/img/products/small-doghouse.jpg", "A small sized doghouse"),
